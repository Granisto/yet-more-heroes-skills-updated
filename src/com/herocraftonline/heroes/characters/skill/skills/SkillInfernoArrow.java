...
/*     */ 
/*     */ public class SkillInfernoArrow extends ActiveSkill
/*     */ {
/*     */   public SkillInfernoArrow(Heroes plugin)
/*     */   {
/*  29 */     super(plugin, "InfernoArrow");
/*  30 */     setDescription("Much more advanced than Fire Arrow!");
/*  31 */     setUsage("/skill infernoarrow");
/*  32 */     setArgumentRange(0, 0);
/*  33 */     setIdentifiers(new String[] { "skill infernoarrow", "skill infarrow" });
/*  34 */     setTypes(new SkillType[] { SkillType.FIRE, SkillType.BUFF });
/*     */ 
...
/*  55 */     hero.addEffect(new InfernoArrowBuff(this, duration, numAttacks));
...
/* 100 */       Hero hero = SkillInfernoArrow.this.plugin.getCharacterManager().getHero(player);
/* 101 */       if (!hero.hasEffect("InfernoArrowBuff")) {
...
/*     */       }
/*     */ 
/* 134 */       arrow.getWorld().playEffect(arrow.getLocation(), Effect.MOBSPAWNER_FLAMES, 0);
/*     */ 
...
/* 154 */       Hero hero = SkillInfernoArrow.this.plugin.getCharacterManager().getHero(player);
/* 155 */       if (!hero.hasEffect("InfernoArrowBuff")) {
...
/*     */       }
/*     */ 
/* 187 */       projectile.getWorld().playEffect(projectile.getLocation(), Effect.MOBSPAWNER_FLAMES, 0);
/*     */ 
...
/* 195 */         return;
/*     */       }
/* 197 */       Hero hero = SkillInfernoArrow.this.plugin.getCharacterManager().getHero((Player)event.getEntity());
/* 198 */       if (hero.hasEffect("InfernoArrowBuff")) {
/* 199 */         int mana = SkillConfigManager.getUseSetting(hero, this.skill, "mana-per-shot", 1, true);
/* 200 */         if (hero.getMana() < mana)
/* 201 */           hero.removeEffect(hero.getEffect("InfernoArrowBuff"));
/*     */         else
...
/*     */   }
/*     */ 
/*     */   public class InfernoArrowBuff extends ImbueEffect
/*     */   {
...
/* Location:           C:\Users\Awesome\Desktop\CODING\Heroes\YMH Skills\SkillInfernoArrow.jar
 * Qualified Name:     com.herocraftonline.heroes.characters.skill.skills.SkillInfernoArrow
