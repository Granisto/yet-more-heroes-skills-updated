...
/*     */ 
/*     */ public class SkillSonicDischarge extends ActiveSkill
/*     */ {
/*     */   public SkillSonicDischarge(Heroes plugin)
/*     */   {
/*  22 */     super(plugin, "SonicDischarge");
/*  23 */     setDescription("$3 damage + $2s weakness for everyone within $1 blocks of you.");
/*  24 */     setUsage("/skill sonicdischarge");
/*  25 */     setArgumentRange(0, 0);
/*  26 */     setIdentifiers(new String[] { "skill sonicdischarge" });
...
/* 106 */         damageEntity(c, player, damage, EntityDamageEvent.DamageCause.MAGIC);
/*     */       }
...
/* 114 */             damageEntity(p, player, damage, EntityDamageEvent.DamageCause.MAGIC);
/*     */ 
/* 116 */             Hero tHero = this.plugin.getCharacterManager().getHero(p);
/* 117 */             tHero.addEffect(new WeaknessEffect(this, duration, "", ""));
/*     */           }
/*     */         }
/*     */       }
/* 121 */     player.getWorld().playSound(player.getLocation(), Sound.AMBIENCE_THUNDER, 1.0F, 2.0F);
/* 122 */     player.getWorld().playSound(player.getLocation(), Sound.EXPLODE, 1.0F, 0.0F);
/* 123 */     player.getWorld().createExplosion(player.getLocation(), 0.0F, false);
/* 124 */     player.getWorld().playEffect(player.getLocation(), Effect.STEP_SOUND, 8);
/* 125 */     player.getWorld().playEffect(player.getLocation(), Effect.STEP_SOUND, 11);
/* 126 */     player.getWorld().playEffect(player.getLocation(), Effect.STEP_SOUND, 51);
/* 127 */     broadcastExecuteText(hero);
/* 128 */     return SkillResult.NORMAL;
/*     */   }
/*     */ }

/* Location:           C:\Users\Awesome\Desktop\CODING\Heroes\YMH Skills\SkillSonicDischarge.jar
 * Qualified Name:     com.herocraftonline.heroes.characters.skill.skills.SkillSonicDischarge
