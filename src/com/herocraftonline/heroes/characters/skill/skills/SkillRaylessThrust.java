...
/*     */ 
/*     */ public class SkillRaylessThrust extends ActiveSkill
/*     */ {
/*     */   private SkillRaylessThrust blind;
/*     */ 
/*     */   public SkillRaylessThrust(Heroes plugin)
/*     */   {
/*  30 */     super(plugin, "RaylessThrust");
/*  31 */     setDescription("Slicing everyone within a radius of $1, you blind everyone for $2 seconds, and deal $3 damage physical damage!");
/*  32 */     setUsage("/skill raylessthrust");
/*  33 */     setArgumentRange(0, 0);
/*  34 */     setIdentifiers(new String[] { "skill raylessthrust" });
/*  35 */     setTypes(new SkillType[] { SkillType.MOVEMENT, SkillType.PHYSICAL, SkillType.DEBUFF, SkillType.DARK });
/*     */   }
/*     */ 
...
/* 118 */         damageEntity(c, player, damage, EntityDamageEvent.DamageCause.ENTITY_ATTACK);
/*     */       }
...
/* 126 */             damageEntity(p, player, damage, EntityDamageEvent.DamageCause.ENTITY_ATTACK);
/*     */ 
/* 128 */             Hero tHero = this.plugin.getCharacterManager().getHero(p);
/* 129 */             tHero.addEffect(new BlindEffect(this.blind, duration, "", ""));
/*     */           }
/*     */         }
/*     */       }
/* 133 */     player.getWorld().playSound(player.getLocation(), Sound.ZOMBIE_METAL, 1.0F, 0.0F);
/* 134 */     player.getWorld().playSound(player.getLocation(), Sound.WITHER_HURT, 1.0F, 0.0F);
/* 135 */     player.getWorld().playEffect(player.getLocation(), Effect.ENDER_SIGNAL, 1);
/* 136 */     broadcastExecuteText(hero);
/* 137 */     return SkillResult.NORMAL;
/*     */   }
/*     */ }

/* Location:           C:\Users\Awesome\Desktop\CODING\Heroes\YMH Skills\SkillRaylessThrust.jar
 * Qualified Name:     com.herocraftonline.heroes.characters.skill.skills.SkillRaylessThrust
