...
/*     */ 
/*     */ public class SkillImmobilizingSlice extends ActiveSkill
/*     */ {
/*     */   private SkillImmobilizingSlice blind;
/*     */ 
/*     */   public SkillImmobilizingSlice(Heroes plugin)
/*     */   {
/*  30 */     super(plugin, "ImmobilizingSlice");
/*  31 */     setDescription("Wounding everyones pressure points within a radius of $1, you disarm them for $2 seconds, and deal $3 damage physical damage!");
/*  32 */     setUsage("/skill immobilizingslice, or islice");
/*  33 */     setArgumentRange(0, 0);
/*  34 */     setIdentifiers(new String[] { "skill immobilizingslice", "skill islice" });
...
/* 129 */             tHero.addEffect(new DisarmEffect(this.blind, duration, "", ""));
/*     */           }
/*     */         }
/*     */       }
/* 133 */     player.getWorld().playSound(player.getLocation(), Sound.ZOMBIE_METAL, 1.0F, 0.0F);
/* 134 */     player.getWorld().playSound(player.getLocation(), Sound.ZOMBIE_WOODBREAK, 1.0F, 1.0F);
/* 135 */     player.getWorld().playEffect(player.getLocation(), Effect.SMOKE, 0);
/* 136 */     broadcastExecuteText(hero);
/* 137 */     return SkillResult.NORMAL;
/*     */   }
/*     */ }

/* Location:           C:\Users\Awesome\Desktop\CODING\Heroes\YMH Skills\SkillImmobilizingSlice.jar
 * Qualified Name:     com.herocraftonline.heroes.characters.skill.skills.SkillImmobilizingSlice
