...
/*     */ 
/*     */ public class SkillBoulderArrow extends ActiveSkill
/*     */ {
/*     */   public SkillBoulderArrow(Heroes plugin)
/*     */   {
/*  29 */     super(plugin, "BoulderArrow");
/*  30 */     setDescription("As your arrows hit the ground, they cause a loud eruption!");
/*  31 */     setUsage("/skill boulderarrow");
/*  32 */     setArgumentRange(0, 0);
/*  33 */     setIdentifiers(new String[] { "skill boulderarrow", "skill rarrow" });
/*  34 */     setTypes(new SkillType[] { SkillType.EARTH, SkillType.BUFF });
/*     */ 
...
/*  55 */     hero.addEffect(new BoulderArrowBuff(this, duration, numAttacks));
...
/* 100 */       Hero hero = SkillBoulderArrow.this.plugin.getCharacterManager().getHero(player);
/* 101 */       if (!hero.hasEffect("BoulderBuff")) {
...
/* 121 */               Skill.damageEntity(heroes, player, damage, DamageCause.SUFFOCATION);
/*     */             }
...
/* 126 */               Skill.damageEntity(mob, player, damage, DamageCause.SUFFOCATION);
/*     */             }
/*     */           }
/*     */ 
/*     */         }
...
/*     */       }
/*     */ 
/* 134 */       arrow.getWorld().playEffect(arrow.getLocation(), Effect.ZOMBIE_DESTROY_DOOR, 1);
/*     */ 
...
/* 154 */       Hero hero = SkillBoulderArrow.this.plugin.getCharacterManager().getHero(player);
/* 155 */       if (!hero.hasEffect("BoulderArrowBuff")) {
...
/* 173 */             if (heroes.getLocation().distanceSquared(projectile.getLocation()) <= radius) {
                        addSpellTarget(heroes,hero);
/* 174 */               SkillBoulderArrow.damageEntity(heroes, player, damage, DamageCause.SUFFOCATION);
}
/*     */           }
...
/* 178 */             if (t_entity.getLocation().distanceSquared(projectile.getLocation()) <= radius) {
                        addSpellTarget(mob,hero);
/* 179 */               SkillBoulderArrow.damageEntity(mob, player, damage, DamageCause.SUFFOCATION);
/*     */             }
/*     */           }
/*     */ 
/*     */         }
...
/*     */       }
/*     */ 
/* 187 */       projectile.getWorld().playEffect(projectile.getLocation(), Effect.ZOMBIE_DESTROY_DOOR, 1);
/*     */ 
...
/* 195 */         return;
/*     */       }
/* 197 */       Hero hero = SkillBoulderArrow.this.plugin.getCharacterManager().getHero((Player)event.getEntity());
/* 198 */       if (hero.hasEffect("BoulderArrowBuff")) {
/* 199 */         int mana = SkillConfigManager.getUseSetting(hero, this.skill, "mana-per-shot", 1, true);
/* 200 */         if (hero.getMana() < mana)
/* 201 */           hero.removeEffect(hero.getEffect("BoulderArrowBuff"));
/*     */         else
...
/*     */   }
/*     */ 
/*     */   public class BoulderArrowBuff extends ImbueEffect
/*     */   {
